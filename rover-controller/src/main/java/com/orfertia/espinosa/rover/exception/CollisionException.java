...
public class CollisionException extends Exception {
	 ...
	 */
	public CollisionException(RoverLocation roverLocation, Plateau plateau) {
		super("Collision with plateau border detected at location ["+roverLocation.getxPosition()+", "+roverLocation.getyPosition()+"] into a plateau ("+plateau.getWidth()+", "+plateau.getHeight()+")" );
	}
	 ...
	 */
	public CollisionException(List<Rover> collisionedRovers) {		
	 ...
	 */
	private static String getCollisionedRoversMessage(List<Rover> collisionedRovers) {
		StringBuilder stringBuilder = new StringBuilder("Collision between rovers: ");
		for (Rover rover: collisionedRovers) {
			stringBuilder.append(" Rover with id: "+rover.getRoverId()+" and location: ("+rover.getRoverLocation().getxPosition()+", "+rover.getRoverLocation().getyPosition()+")");
		}
